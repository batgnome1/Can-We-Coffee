...
export default class CoffeeshopInteractScene extends Phaser.Scene
    {
        constructor() 
            {
                super({key: 'coffeeshopInteractScene', active: false});
        ...
        create()
            {
                ...
                let weep = this.add.sprite(70, 100, 'avatar').setFrame(5);
                weep.setScale(5);

                this.add.text(700, 560, 'Skeev', { fontFamily: 'myFont', fontSize: '16px', color: '#ffffff' }).setOrigin(0.5);
                this.add.text(65, 200, 'Weep', { fontFamily: 'myFont', fontSize: '16px', color: '#ffffff' }).setOrigin(0.5);


                                const currentSceneKey = 'cafeScene';
                                const previousScene = 'coffeeshopScene';
                                const currentNPC = 'weep';
                                                ...
                                                this.currentState = 'topicSelection';
                                            ...
                                            else if (this.currentState === 'topicSelection')
                                                    {
                                            ...
                                            else if (this.currentState === 'optionSelection')
                                                        {
                                                            ...
                                                            persistentInventory.slotTwo = startLines.topics[this.topicChoice].options[this.optionChoice];
                                                           /* this.time.delayedCall(3000, () => {
                ...
                this.exitKey.on('down', () => this.scene.start('coffeeshopScene'));
