...
export default class ThriftshopInteractScene extends Phaser.Scene
    {
        constructor() 
            {
                super({key: 'thriftshopInteractScene', active: false});
        ...
        create()
            {
                ...
                let grizzo = this.add.sprite(70, 100, 'avatar').setFrame(4);
                grizzo.setScale(5);

                this.add.text(700, 560, 'Skeev', { fontFamily: 'myFont', fontSize: '16px', color: '#ffffff' }).setOrigin(0.5);
                this.add.text(65, 200, 'Grizzo', { fontFamily: 'myFont', fontSize: '16px', color: '#ffffff' }).setOrigin(0.5);


                                const currentSceneKey = 'thriftScene';
                                const previousScene = 'thriftshopScene';
                                const currentNPC = 'grizzo';
                                                ...
                                                this.currentState = 'topicSelection';
                                            ...
                                            else if (this.currentState === 'topicSelection')
                                                    {
                                            ...
                                            else if (this.currentState === 'optionSelection')
                                                        {
                                                            ...
                                                            persistentInventory.slotThree = startLines.topics[this.topicChoice].options[this.optionChoice];
                ...
                this.exitKey.on('down', () => this.scene.start('thriftshopScene'));
